...
router.post('/add', cartController_1.addCartItem);
router.patch('/:id', cartController_1.updateCartItemQuantity);
router.put('/item/:id', cartController_1.updateCartItemQuantity);
router.delete('/:id', cartController_1.removeCartItem);
router.delete('/item/:id', cartController_1.removeCartItem);

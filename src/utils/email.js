    ...
    <tr>
      <td style="padding: 20px 32px 28px; text-align: center;">
        <p style="margin: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12px; color: #9CA3AF; line-height: 1.6;">
          ...
          Need help? Contact us at <a href="mailto:${config_1.default.smtpUser}" style="color: #6366F1; text-decoration: none; font-weight: 600;">${config_1.default.smtpUser}</a>
        </p>
      </td>
    </tr>
  `;
...
const sendWelcomeEmail = async (email, name, role) => {
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
          <tr>
            <td style="background: linear-gradient(135deg, #4F46E5, #7C3AED); border-radius: 10px;">
              <a href="${config_1.default.clientUrl}/login" style="display: inline-block; padding: 14px 40px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 15px; font-weight: 700; color: #FFFFFF; text-decoration: none; letter-spacing: 0.3px;">
                Start Exploring →
              </a>
            </td>
          </tr>
    ...
    <tr>
      <td style="padding: 20px 32px 28px; text-align: center;">
        <p style="margin: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12px; color: #9CA3AF; line-height: 1.6;">
          Questions? Reach us at <a href="mailto:${config_1.default.smtpUser}" style="color: #6366F1; text-decoration: none; font-weight: 600;">${config_1.default.smtpUser}</a>
        </p>
      </td>
    </tr>
  `;
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
          <tr>
            <td style="background: linear-gradient(135deg, #059669, #10B981); border-radius: 10px;">
              <a href="${config_1.default.clientUrl}/login" style="display: inline-block; padding: 14px 40px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 15px; font-weight: 700; color: #FFFFFF; text-decoration: none;">
                Log In Now →
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 16px 20px; text-align: center;">
              ...
              <p style="margin: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 13px; color: #6B7280;">
                Contact us at <a href="mailto:${config_1.default.smtpUser}" style="color: #6366F1; text-decoration: none; font-weight: 600;">${config_1.default.smtpUser}</a>
              </p>
            </td>
          </tr>
        </table>
    ...
    <tr>
      <td style="padding: 20px 32px 28px; text-align: center;">
        <p style="margin: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12px; color: #9CA3AF;">
          <a href="${config_1.default.clientUrl}" style="color: #6366F1; text-decoration: none; font-weight: 600;">Visit Finding Moto</a>
        </p>
      </td>
    </tr>
  `;
